...
const FAQ = () => {
    return (
        <div className='max-w-4xl mx-auto py-8'>
            <h1 className='text-3xl text-primary font-bold text-center mb-4'>Frequently Asked Questions</h1>
            <div tabIndex={0} className="collapse collapse-arrow border border-base-300 bg-base-100 rounded mb-1">
